...
public class SimpleGeofence {
    ...
    public SimpleGeofence(
        ...
        // Id of the message to retrieve from the server
        this.msgId = msgIdRhs;
    }
    ...
    /**
     * Get the ID of the message associated with this geofence
     * @return String ID of the message tied to this geofence
     */
    ...
    public String toString() {
    	String msg = String.format("%s: %.2f, %.2f, %.2f",
    			getId(), getLatitude(), getLongitude(), getRadius());
    	return msg;
    }
}
